...
print(f"Sua parede tem dimensoes {largura}M x {altura}M. A area da sua parede é {areaparede} metros quadrados, sabendo que um litro de tinta é usado a cada dois metros quadrados, voce tera que usar {areatinta} litros de tinta")